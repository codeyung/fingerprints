/**
 * Created by codeyung on 2018/7/3.
 */
        ...
        h = function () {
            ...
            function t(e) {
                var n, t = -1,
                    r = e.length,
                    i = [];
                if (/^[-]*$/.test(e)) for (; ++t < r;) i.push(e.charCodeAt(t));
        ...
        C = function () {
            ...
            function i(e) {
                for (var t, i, o, a, c = e.split("\r\n"), u = 0; u < c.length; u++) {
                    ...
                    a && !l[a] && /[0-9]{1,3}(\.[0-9]{1,3}){3}/.test(a) && ("0.0.0.0" == a || 0 == a.indexOf("127.") || 3758096384 == (4026531840 & r(a)) || (l[a] = 1, s.push(a)))
                }
                s.length && n()
            }
